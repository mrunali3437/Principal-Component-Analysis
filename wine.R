...
plot(wine_pca$scores[,1:2], col = "black", pch = 19, cex = 1)
...
kmean_table
round(sum(diag(kmean_table))/sum(kmean_table)*100)

#The most accurate clusters that almost matched with the dataset was found with hierarchical clusters.
